...
CREATE TABLE `jogos` (
  ...
  `golos1` int(11) DEFAULT NULL,
  `golos2` int(11) DEFAULT NULL,
  `odds1` double DEFAULT NULL,
  `oddsx` double DEFAULT NULL,
  `odds2` double DEFAULT NULL,
  `estado` varchar(6) DEFAULT NULL,
  `dcria` date DEFAULT NULL,
  `daltera` date DEFAULT NULL,
  `competicao` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`casa`,`fora`,`data`)
...
-- Dump completed on 2016-07-28 15:34:56
